...
function getCurrentUser() {
  ...
  if (storageUser != null) {
    ...
    document.getElementById("profile-link").innerHTML = "";
    document.getElementById("profile-link").innerHTML = `
      <a class="nav-link" onclick="profileClicked()" data-bs-toggle="modal" data-bs-target="#login-or-reg-post-modal">Profile</a>
      `;
  }
  return currentUser;
}
...
function profileClicked() {
  ...
  window.location = `/profile page/profile.html?userId=${user.id}`;
}
